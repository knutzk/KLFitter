...
int LikelihoodTopLeptonJets::SavePermutedParticles() {
  m_bhad_meas_e      = (*m_particles_permuted)->GetP4(Particles::Type::kParton, 0)->E();
  m_bhad_meas_deteta = (*m_particles_permuted)->partons.at(0).GetDetEta();
  m_bhad_meas_px     = (*m_particles_permuted)->GetP4(Particles::Type::kParton, 0)->Px();
  m_bhad_meas_py     = (*m_particles_permuted)->GetP4(Particles::Type::kParton, 0)->Py();
  m_bhad_meas_pz     = (*m_particles_permuted)->GetP4(Particles::Type::kParton, 0)->Pz();
  m_bhad_meas_m      = SetPartonMass((*m_particles_permuted)->GetP4(Particles::Type::kParton, 0)->M(), m_physics_constants.MassBottom(), &m_bhad_meas_px, &m_bhad_meas_py, &m_bhad_meas_pz, m_bhad_meas_e);
  m_bhad_meas_p      = sqrt(m_bhad_meas_e*m_bhad_meas_e - m_bhad_meas_m*m_bhad_meas_m);

  m_blep_meas_e      = (*m_particles_permuted)->GetP4(Particles::Type::kParton, 1)->E();
  m_blep_meas_deteta = (*m_particles_permuted)->partons.at(1).GetDetEta();
  m_blep_meas_px     = (*m_particles_permuted)->GetP4(Particles::Type::kParton, 1)->Px();
  m_blep_meas_py     = (*m_particles_permuted)->GetP4(Particles::Type::kParton, 1)->Py();
  m_blep_meas_pz     = (*m_particles_permuted)->GetP4(Particles::Type::kParton, 1)->Pz();
  m_blep_meas_m      = SetPartonMass((*m_particles_permuted)->GetP4(Particles::Type::kParton, 1)->M(), m_physics_constants.MassBottom(), &m_blep_meas_px, &m_blep_meas_py, &m_blep_meas_pz, m_blep_meas_e);
  m_blep_meas_p      = sqrt(m_blep_meas_e*m_blep_meas_e - m_blep_meas_m*m_blep_meas_m);

  m_lq1_meas_e      = (*m_particles_permuted)->GetP4(Particles::Type::kParton, 2)->E();
  m_lq1_meas_deteta = (*m_particles_permuted)->partons.at(2).GetDetEta();
  m_lq1_meas_px     = (*m_particles_permuted)->GetP4(Particles::Type::kParton, 2)->Px();
  m_lq1_meas_py     = (*m_particles_permuted)->GetP4(Particles::Type::kParton, 2)->Py();
  m_lq1_meas_pz     = (*m_particles_permuted)->GetP4(Particles::Type::kParton, 2)->Pz();
  m_lq1_meas_m      = SetPartonMass((*m_particles_permuted)->GetP4(Particles::Type::kParton, 2)->M(), 0., &m_lq1_meas_px, &m_lq1_meas_py, &m_lq1_meas_pz, m_lq1_meas_e);
  m_lq1_meas_p      = sqrt(m_lq1_meas_e*m_lq1_meas_e - m_lq1_meas_m*m_lq1_meas_m);

  m_lq2_meas_e      = (*m_particles_permuted)->GetP4(Particles::Type::kParton, 3)->E();
  m_lq2_meas_deteta = (*m_particles_permuted)->partons.at(3).GetDetEta();
  m_lq2_meas_px     = (*m_particles_permuted)->GetP4(Particles::Type::kParton, 3)->Px();
  m_lq2_meas_py     = (*m_particles_permuted)->GetP4(Particles::Type::kParton, 3)->Py();
  m_lq2_meas_pz     = (*m_particles_permuted)->GetP4(Particles::Type::kParton, 3)->Pz();
  m_lq2_meas_m      = SetPartonMass((*m_particles_permuted)->GetP4(Particles::Type::kParton, 3)->M(), 0., &m_lq2_meas_px, &m_lq2_meas_py, &m_lq2_meas_pz, m_lq2_meas_e);
  ...
  if (m_lepton_type == kElectron) {
    ...
    m_lep_meas_deteta = (*m_particles_permuted)->electrons.at(0).GetDetEta();
  } else {
    lepton = (*m_particles_permuted)->GetP4(Particles::Type::kMuon, 0);
    m_lep_meas_deteta = (*m_particles_permuted)->muons.at(0).GetDetEta();
  }
...
int LikelihoodTopLeptonJets::SaveResolutionFunctions() {
  m_res_energy_bhad = (*m_detector)->ResEnergyBJet(m_bhad_meas_deteta);
  m_res_energy_blep = (*m_detector)->ResEnergyBJet(m_blep_meas_deteta);
  m_res_energy_lq1  = (*m_detector)->ResEnergyLightJet(m_lq1_meas_deteta);
  m_res_energy_lq2  = (*m_detector)->ResEnergyLightJet(m_lq2_meas_deteta);
  if (m_lepton_type == kElectron) {
    m_res_lepton = (*m_detector)->ResEnergyElectron(m_lep_meas_deteta);
  } else if (m_lepton_type == kMuon) {
    m_res_lepton = (*m_detector)->ResEnergyMuon(m_lep_meas_deteta);
  }
  m_res_met = (*m_detector)->ResMissingET();
